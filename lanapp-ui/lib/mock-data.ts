...
export const breedingData: BreedingRecord[] = [
  { id: "b-1", eweId: "SA-103", ramId: "SA-055", cycleName: "2026-A", matingDate: "2026-03-15", vitaselApplied: true, result: "Pendiente" },
  { id: "b-2", eweId: "SA-088", ramId: "SA-055", cycleName: "2026-A", matingDate: "2026-03-16", vitaselApplied: false, result: "Preñada", diagnosisType: "ECO", diagnosisDate: "2026-04-15" },
  { id: "b-3", eweId: "SA-001", ramId: "SA-042", cycleName: "2026-A", matingDate: "2026-02-10", vitaselApplied: true, result: "Vacía", diagnosisType: "ECO", diagnosisDate: "2026-03-12" },
  { id: "b-4", eweId: "SA-077", ramId: "SA-055", cycleName: "2026-A", matingDate: "2026-02-28", vitaselApplied: false, result: "Revisar", diagnosisType: "Control monta", diagnosisDate: "2026-03-25" },
  { id: "b-5", eweId: "SA-015", ramId: "SA-042", cycleName: "2026-B", matingDate: "2026-05-02", vitaselApplied: true, result: "Pendiente" },
  { id: "b-6", eweId: "SA-022", cycleName: "2026-B", matingDate: "2026-05-03", vitaselApplied: false, result: "Pendiente" },
]
